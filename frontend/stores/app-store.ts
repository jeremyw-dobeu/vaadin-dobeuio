...
import User from 'Frontend/generated/com/example/application/data/entity/User.js';
import Role from 'Frontend/generated/com/example/application/data/Role.js';
import { UserEndpoint } from 'Frontend/generated/endpoints.js';
import { makeAutoObservable } from 'mobx';

export class AppStore {
  applicationName = 'vaadin-dobeuio';
